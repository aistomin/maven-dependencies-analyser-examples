...
```
[ERROR] Failed to execute goal com.github.aistomin:maven-dependencies-analyser:1.1:check (default) on project maven-dependencies-analyser-examples: com.github.aistomin:maven-browser (version 1.2) has newer versions: 1.4; 1.3 -> [Help 1]
```
